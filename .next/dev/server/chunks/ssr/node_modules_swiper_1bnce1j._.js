    ...
    if (needNavigationInit && navigation) {
        if (swiper.isElement) {
            if (!nextEl || typeof nextEl === 'string') {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["w"])(el, navigation.arrowSvg);
...
function calcDevice({ userAgent } = {}) {
    ...
    const isIPhoneOrIPod = undefined;
    const isIPadDirect = undefined;
    // iPad on iPadOS 13+ reports as MacIntel; distinguish from a real Mac by touch capability.
    const isIPadMasquerade = undefined;
    const isIPad = undefined;
    const isWindows = undefined;
}
...
function setBreakpoint() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["n"])(swiper.params, breakpointParams);
...
function onTouchEnd(event) {
    ...
    // Time diff
    const touchEndTime = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["u"])();
    ...
    data.lastClickTime = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["u"])();
...
function onTouchMove(event) {
    ...
    if (!swiper.allowTouchMove) {
        ...
        if (data.isTouched) {
            ...
            data.touchStartTime = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["u"])();
        }
        return;
    }
...
function onTouchStart(event) {
    ...
    if (params.touchEventsTarget === 'wrapper') {
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["f"])(targetEl, swiper.wrapperEl)) return;
    }
...
function loopCreate(slideRealIndex, initial) {
    ...
    const addBlankSlides = (amountOfSlides)=>{
        for(let i = 0; i < amountOfSlides; i += 1){
            const slideEl = swiper.isElement ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["a"])('swiper-slide', [
                params.slideBlankClass
            ]) : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["a"])('div', [
                params.slideClass,
                params.slideBlankClass
            ]);
    ...
    if (shouldFillGroup) {
        if (params.loopAddBlankSlides) {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["x"])('Swiper Loop Warning: The number of slides is not even to slidesPerGroup, loop mode may not function properly. You need to add more slides (or make duplicates, or empty slides)');
        }
        initSlides();
        ...
        if (params.loopAddBlankSlides) {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["x"])('Swiper Loop Warning: The number of slides is not even to grid.rows, loop mode may not function properly. You need to add more slides (or make duplicates, or empty slides)');
        }
        initSlides();
    } else {
        initSlides();
...
function loopFix(options = {}) {
    ...
    if (slides.length < slidesPerView + loopedSlides || swiper.params.effect === 'cards' && slides.length < slidesPerView + loopedSlides * 2) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["x"])('Swiper Loop Warning: The number of slides is not enough for loop mode, it will be disabled or not function properly. You need to add more slides (or make duplicates) or lower the values of slidesPerView and slidesPerGroup parameters');
    } else if (gridEnabled && params.grid.fill === 'row') {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["x"])('Swiper Loop Warning: Loop mode is not compatible with grid.fill = `row`');
    }
...
function moduleExtendParams(params, allModulesParams) {
    return function extendParams(obj = {}) {
        ...
        if (typeof moduleParams !== 'object' || moduleParams === null) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["n"])(allModulesParams, obj);
            return;
        }
...
const Observer = ({ swiper, extendParams, on })=>{
    ...
    const init = ()=>{
        ...
        if (swiper.params.observeParents) {
            const containerParents = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["j"])(swiper.hostEl);
...
function getSwiperTranslate(axis = this.isHorizontal() ? 'x' : 'y') {
    ...
    let currentTranslate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["q"])(wrapperEl, axis);
...
function updateSize() {
    ...
    // Subtract paddings
    width = width - parseInt((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["l"])(el, 'padding-left') || '0', 10) - parseInt((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["l"])(el, 'padding-right') || '0', 10);
    height = height - parseInt((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["l"])(el, 'padding-top') || '0', 10) - parseInt((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["l"])(el, 'padding-bottom') || '0', 10);
...
function updateSlides() {
    ...
    if (params.centeredSlides && params.cssMode) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["v"])(wrapperEl, '--swiper-centered-offset-before', '');
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["v"])(wrapperEl, '--swiper-centered-offset-after', '');
    }
    // set cssMode offsets
    if (params.cssMode) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["v"])(wrapperEl, '--swiper-slides-offset-before', `${offsetBefore}px`);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["v"])(wrapperEl, '--swiper-slides-offset-after', `${offsetAfter}px`);
    }
    ...
    for(let i = 0; i < slidesLength; i += 1){
        ...
        if (slide) {
            ...
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["l"])(slide, 'display') === 'none') continue;
        }
    ...
    if (params.centeredSlides && params.cssMode && !params.centeredSlidesBounds) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["v"])(wrapperEl, '--swiper-centered-offset-before', `${-snapGrid[0]}px`);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["v"])(wrapperEl, '--swiper-centered-offset-after', `${swiper.size / 2 - slidesSizesGrid[slidesSizesGrid.length - 1] / 2}px`);
...
function updateSlidesClasses() {
    ...
    if (activeSlide) {
        if (!gridEnabled) {
            // Next Slide
            nextSlide = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["g"])(activeSlide, `.${params.slideClass}, swiper-slide`)[0];
            if (params.loop && !nextSlide) {
                nextSlide = slides[0];
            }
            // Prev Slide
            prevSlide = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["k"])(activeSlide, `.${params.slideClass}, swiper-slide`)[0];
...
class Swiper {
    ...
    constructor(...args){
        ...
        if (!params) params = {};
        params = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["n"])({}, params);
        ...
        if (params.el && typeof params.el === 'string' && typeof document !== 'undefined' && document.querySelectorAll(params.el).length > 1) {
            ...
            document.querySelectorAll(params.el).forEach((containerEl)=>{
                const newParams = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["n"])({}, params, {
                    el: containerEl
                });
        ...
        const swiperParams = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["n"])({}, defaults, allModulesParams);
        // Extend defaults with passed params
        swiper.params = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["n"])({}, swiperParams, extendedDefaults, params);
        swiper.originalParams = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["n"])({}, swiper.params);
        swiper.passedParams = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["n"])({}, params);
        // add event listeners
    ...
    getSlideIndex(slideEl) {
        ...
        const slides = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["e"])(slidesEl, `.${params.slideClass}, swiper-slide`);
        const firstSlideIndex = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["b"])(slides[0]);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["b"])(slideEl) - (firstSlideIndex ?? 0);
    }
    ...
    recalcSlides() {
        const { slidesEl, params } = this;
        this.slides = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["e"])(slidesEl, `.${params.slideClass}, swiper-slide`);
    }
    /**
    ...
    mount(element) {
        ...
        if (!wrapperEl && swiper.params.createElements) {
            wrapperEl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["a"])('div', swiper.params.wrapperClass);
            el.append(wrapperEl);
        ...
        Object.assign(swiper, {
            ...
            mounted: true,
            // RTL
            rtl: el.dir.toLowerCase() === 'rtl' || (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["l"])(el, 'direction') === 'rtl',
            rtlTranslate: swiper.params.direction === 'horizontal' && (el.dir.toLowerCase() === 'rtl' || (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["l"])(el, 'direction') === 'rtl'),
            wrongRTL: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["l"])(wrapperEl, 'display') === '-webkit-box'
        });
        return true;
    }
    /**
     ...
     */ destroy(deleteInstance = true, cleanStyles = true) {
        ...
        if (deleteInstance !== false) {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["d"])(swiper);
        }
        swiper.destroyed = true;
        return null;
    }
    static extendDefaults(newDefaults) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["n"])(extendedDefaults, newDefaults);
    }
...
function getChangedParams(swiperParams, oldParams, children, oldChildren, getKey) {
    ...
    watchParams.forEach((key)=>{
        if (key in swiperParams && key in oldParams) {
            ...
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$update$2d$swiper$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["i"])(newVal) && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$update$2d$swiper$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["i"])(oldVal)) {
...
function getParams(obj = {}, splitEvents = true) {
    ...
    Object.keys(plainObj).forEach((key)=>{
        ...
        if (allowedParams.indexOf(key) >= 0) {
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$update$2d$swiper$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["i"])(value)) {
                params[key] = {};
                passedParams[key] = {};
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$update$2d$swiper$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["e"])(params[key], value);
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$update$2d$swiper$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["e"])(passedParams[key], value);
            } else {
                params[key] = value;
...
function mountSwiper(refs, swiperParams) {
    ...
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$update$2d$swiper$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["b"])(swiperParams) && paginationEl) {
        swiper.params.pagination.el = paginationEl;
        swiper.originalParams.pagination.el = paginationEl;
    }
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$update$2d$swiper$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["c"])(swiperParams) && scrollbarEl) {
...
;
;
const SwiperSlideContext = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createContext"])(null);
const useSwiperSlide = ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useContext"])(SwiperSlideContext);
const SwiperContext = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createContext"])(null);
const useSwiper = ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useContext"])(SwiperContext);
...
const Swiper = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["forwardRef"])(function Swiper(propsArg, externalElRef) {
    ...
    const { params: swiperParams, passedParams, rest: restProps, events } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$update$2d$on$2d$virtual$2d$data$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["a"])(rest);
    ...
    const initSwiper = ()=>{
        ...
        if (instance.virtual && instance.params.virtual?.enabled) {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$update$2d$swiper$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["e"])(instance.params.virtual, extendWith);
            if (instance.originalParams.virtual) (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$update$2d$swiper$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["e"])(instance.originalParams.virtual, extendWith);
        }
    };
    ...
    useIsomorphicLayoutEffect(()=>{
        attachEvents();
        const changedParams = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$update$2d$on$2d$virtual$2d$data$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["g"])(passedParams, oldPassedParamsRef.current, slides, oldSlides.current, (c)=>c.key);
        oldPassedParamsRef.current = passedParams;
        oldSlides.current = slides;
        if (changedParams.length && swiperRef.current && !swiperRef.current.destroyed) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$update$2d$swiper$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["d"])({
                swiper: swiperRef.current,
                slides,
                passedParams,
                changedParams,
    ...
    function renderSlides() {
        ...
        return slides.map((child, index)=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].cloneElement(child, {
                swiper: swiperRef.current,
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].createElement(TagComponent, {
        ref: swiperElRef,
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$update$2d$swiper$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["u"])(`${containerClasses}${className ? ` ${className}` : ''}`),
        ...restProps
    }, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].createElement(SwiperContext.Provider, {
        value: swiperRef.current
    }, slots['container-start'], __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].createElement(WrapperComponent, {
    ...
    })), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$update$2d$swiper$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["c"])(swiperParams) && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].createElement("div", {
        ref: scrollbarElRef,
        className: "swiper-scrollbar"
    }), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$update$2d$swiper$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["b"])(swiperParams) && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].createElement("div", {
        ref: paginationElRef,
        className: "swiper-pagination"
    }), slots['container-end']));
});
Swiper.displayName = 'Swiper';
const SwiperSlide = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["forwardRef"])(function SwiperSlide(props, externalRef) {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].createElement(TagComponent, {
        ref: slideElRef,
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$update$2d$swiper$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["u"])(`${slideClasses}${className ? ` ${className}` : ''}`),
        "data-swiper-slide-index": virtualIndex,
        onLoad: onLoad,
        ...rest
    }, zoom && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].createElement(SwiperSlideContext.Provider, {
        value: slideData
    }, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].createElement("div", {
        className: "swiper-zoom-container",
        "data-swiper-zoom": typeof zoom === 'number' ? zoom : undefined
    }, renderChildren(), lazy && !lazyLoaded && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].createElement("div", {
...
const Virtual = ({ swiper, extendParams, on, emit })=>{
    ...
    function renderSlide(slide, index) {
        ...
        if (params.renderSlide) {
            ...
            if (typeof rendered === 'string') {
                const el = getTempDOM();
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["w"])(el, rendered);
                slideEl = el.children[0];
            } else {
                slideEl = rendered;
            }
        } else if (swiper.isElement) {
            slideEl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["a"])('swiper-slide');
        } else {
            slideEl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["a"])('div', swiper.params.slideClass);
        }
        slideEl.setAttribute('data-swiper-slide-index', String(index));
        if (!params.renderSlide) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["w"])(slideEl, slide);
        }
        if (params.cache) {
    ...
    on('init update resize', ()=>{
        if (!getParams().enabled) return;
        if (swiper.params.cssMode) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["v"])(swiper.wrapperEl, '--swiper-virtual-size', `${swiper.virtualSize}px`);
        }
    });
    Object.assign(swiper.virtual, {
        appendSlide,
...
const Keyboard = ({ swiper, extendParams, on, emit })=>{
    ...
    function handle(event) {
        ...
        if (params.onlyInViewport && (isPageUp || isPageDown || isArrowLeft || isArrowRight || isArrowUp || isArrowDown)) {
            ...
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["j"])(swiper.el, `.${swiper.params.slideClass}, swiper-slide`).length > 0 && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["j"])(swiper.el, `.${swiper.params.slideActiveClass}`).length === 0) {
                return undefined;
            }
            const el = swiper.el;
            ...
            const swiperOffset = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["h"])(el);
...
const Mousewheel = ({ swiper, extendParams, on, emit })=>{
    ...
    let timeout;
    let lastScrollTime = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["u"])();
    ...
    function animateSlider(newEvent) {
        ...
        if (params.thresholdTime && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["u"])() - lastScrollTime < params.thresholdTime) {
        ...
        if (newEvent.delta >= 6 && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["u"])() - lastScrollTime < 60) {
    ...
    function handle(event) {
        ...
        if (!swiper.params.freeMode || !freeModeParams?.enabled) {
            ...
            const newEvent = {
                time: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["u"])(),
            ...
            if (!ignoreWheelEvents) {
                ...
                if (freeModeParams?.sticky) {
                    ...
                    if (prevEvent && (newEvent.delta > prevEvent.delta || newEvent.direction !== prevEvent.direction)) {
                        ...
                        recentWheelEvents.splice(0);
                        timeout = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["t"])(()=>{
    ...
    if (swiper.params.createElements) {
        Object.keys(checkProps).forEach((key)=>{
            if (!target[key] && target.auto === true) {
                ...
                if (!element) {
                    element = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["a"])('div', checkProps[key]);
...
const Navigation = ({ swiper, extendParams, on, emit })=>{
    ...
    function toggleEl(el, disabled) {
        const params = getParams();
        const els = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["s"])(el);
        els.forEach((subEl)=>{
            if (subEl) {
    ...
    function init() {
        ...
        const nextEls = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["s"])(nextEl);
        const prevEls = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["s"])(prevEl);
        const initButton = (el, dir)=>{
            if (el) {
                if (params.addIcons && el.matches('.swiper-button-next,.swiper-button-prev') && !el.querySelector('svg')) {
                    const tempEl = document.createElement('div');
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["w"])(tempEl, arrowSvg);
...
const Pagination = ({ swiper, extendParams, on, emit })=>{
    ...
    function onBulletClick(e) {
        const targetEl = e.target;
        const bulletEl = targetEl.closest((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$classes$2d$to$2d$selector$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["c"])(getParams().bulletClass));
        if (!bulletEl) {
            return;
        }
        e.preventDefault();
        const index = ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["b"])(bulletEl) ?? 0) * (swiper.params.slidesPerGroup ?? 1);
        if (swiper.params.loop) {
    ...
    function update() {
        ...
        const els = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["s"])(swiper.pagination.el);
        // Current/Total
        let current;
        let previousIndex;
        ...
        if (params.type === 'bullets' && swiper.pagination.bullets && swiper.pagination.bullets.length > 0) {
            ...
            if (params.dynamicBullets) {
                bulletSize = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["i"])(bullets[0], swiper.isHorizontal() ? 'width' : 'height');
            ...
            if (els.length > 1) {
                bullets.forEach((bullet)=>{
                    const bulletIndex = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["b"])(bullet);
        ...
        els.forEach((subEl, subElIndex)=>{
            ...
            if (params.type === 'custom' && params.renderCustom) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["w"])(subEl, params.renderCustom(swiper, current + 1, total));
    ...
    function render() {
        ...
        els.forEach((subEl)=>{
            if (params.type !== 'custom') {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["w"])(subEl, paginationHTML || '');
            }
            if (params.type === 'bullets') {
                swiper.pagination.bullets.push(...Array.from(subEl.querySelectorAll((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$classes$2d$to$2d$selector$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["c"])(params.bulletClass))));
            }
        });
        if (params.type !== 'custom') {
        ...
        if (swiper.params.uniqueNavElements && typeof params.el === 'string' && Array.isArray(el) && el.length > 1) {
            ...
            if (el.length > 1) {
                const found = el.find((subEl)=>{
                    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["j"])(subEl, '.swiper')[0] !== swiper.el) return false;
                    return true;
                });
                if (found) el = found;
            }
...
const Scrollbar = ({ swiper, extendParams, on, emit })=>{
    ...
    function setDragPosition(e) {
        ...
        const { el } = scrollbar;
        let positionRatio;
        positionRatio = (getPointerPosition(e) - (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["h"])(el)[swiper.isHorizontal() ? 'left' : 'top'] - (dragStartPos !== null ? dragStartPos : dragSize / 2)) / (trackSize - dragSize);
    ...
    function onDragEnd(e) {
        ...
        if (params.hide) {
            if (dragTimeout) clearTimeout(dragTimeout);
            dragTimeout = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["t"])(()=>{
                el.style.opacity = '0';
                el.style.transitionDuration = '400ms';
            }, 1000);
        }
    ...
    function init() {
        ...
        let dragEl = null;
        if (elTyped) {
            dragEl = elTyped.querySelector((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$classes$2d$to$2d$selector$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["c"])(params.dragClass));
            if (!dragEl) {
                dragEl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["a"])('div', params.dragClass);
        ...
        if (elTyped) {
            elTyped.classList[swiper.enabled ? 'remove' : 'add'](...(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["c"])(params.lockClass));
        }
    }
    function destroy() {
        const params = getParams();
        ...
        if (el) {
            el.classList.remove(...(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["c"])(swiper.isHorizontal() ? params.horizontalClass : params.verticalClass));
        }
        disableDraggable();
    }
    on('changeDirection', ()=>{
        ...
        const params = getParams();
        const els = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["s"])(swiper.scrollbar.el);
        els.forEach((subEl)=>{
            subEl.classList.remove(params.horizontalClass, params.verticalClass);
            subEl.classList.add(swiper.isHorizontal() ? params.horizontalClass : params.verticalClass);
        });
    ...
    on('enable disable', ()=>{
        ...
        if (el) {
            el.classList[swiper.enabled ? 'remove' : 'add'](...(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["c"])(getParams().lockClass));
        }
    });
    on('destroy', ()=>{
        destroy();
    ...
    const enable = ()=>{
        const params = getParams();
        swiper.el.classList.remove(...(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["c"])(params.scrollbarDisabledClass));
        if (swiper.scrollbar.el) {
            swiper.scrollbar.el.classList.remove(...(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["c"])(params.scrollbarDisabledClass));
        }
        init();
        updateSize();
        setTranslate();
    ...
    const disable = ()=>{
        const params = getParams();
        swiper.el.classList.add(...(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["c"])(params.scrollbarDisabledClass));
        if (swiper.scrollbar.el) {
            swiper.scrollbar.el.classList.add(...(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["c"])(params.scrollbarDisabledClass));
        }
        destroy();
    };
...
const Zoom = ({ swiper, extendParams, on, emit })=>{
    ...
    function onGestureStart(e) {
        ...
        if (!gesture.slideEl) {
            ...
            if (imageEl) {
                gesture.imageWrapEl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["j"])(imageEl, `.${params.containerClass}`)[0] ?? undefined;
            } else {
    ...
    function onTouchMove(e) {
        ...
        if (!image.isMoved) {
            ...
            image.startX = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["q"])(gesture.imageWrapEl, 'x') || 0;
            image.startY = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["q"])(gesture.imageWrapEl, 'y') || 0;
    ...
    function zoomIn(e) {
        ...
        if (!gesture.slideEl) {
            ...
            if (!gesture.slideEl) {
                ...
                if (virtual && virtual.enabled && swiper.virtual) {
                    gesture.slideEl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["e"])(swiper.slidesEl, `.${swiper.params.slideActiveClass}`)[0] ?? undefined;
                } else {
        ...
        if (e && !(currentScale === 1 && forceZoomRatio)) {
            ...
            offsetX = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["h"])(gesture.slideEl).left + window.scrollX;
            offsetY = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["h"])(gesture.slideEl).top + window.scrollY;
...
const Controller = ({ swiper, extendParams, on })=>{
    ...
    function setTransition(duration, byController) {
        ...
        function setControlledTransition(c) {
            ...
            if (duration !== 0) {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["m"])(c.wrapperEl, ()=>{
    ...
    on('beforeInit', ()=>{
        ...
        if (("TURBOPACK compile-time value", "undefined") !== 'undefined' && (typeof controllerParam === 'string' || controllerParam instanceof HTMLElement)) //TURBOPACK unreachable
        ;
...
const A11y = ({ swiper, extendParams, on })=>{
    ...
    function notify(message) {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["w"])(notification, message);
    }
    ...
    function onEnterOrSpaceKey(e) {
        ...
        if (swiper.pagination && swiper.pagination.el && (targetEl === swiper.pagination.el || swiper.pagination.el.contains(targetEl))) {
            if (!targetEl.matches((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$classes$2d$to$2d$selector$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["c"])(paginationParams?.bulletClass))) return;
        }
        if (swiper.navigation && swiper.navigation.prevEl && swiper.navigation.nextEl) {
            const prevEls = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["s"])(swiper.navigation.prevEl);
            const nextEls = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["s"])(swiper.navigation.nextEl);
        ...
        if (swiper.pagination && targetEl.matches((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$classes$2d$to$2d$selector$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["c"])(paginationParams?.bulletClass))) {
            targetEl.click();
        }
    }
        ...
        swiper.pagination.bullets.forEach((bulletEl)=>{
            if (paginationParams.clickable) {
                ...
                if (!paginationParams.renderBullet) {
                    ...
                    addElLabel(bulletEl, params.paginationBulletMessage.replace(/\{\{index\}\}/, String(((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["b"])(bulletEl) ?? 0) + 1)));
                }
            }
            if (bulletEl.matches((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$classes$2d$to$2d$selector$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["c"])(paginationParams.bulletActiveClass))) {
    ...
    const init = ()=>{
        ...
        const nextEls = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["s"])(nav.nextEl);
        const prevEls = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["s"])(nav.prevEl);
        if (nextEls) {
        ...
        if (hasClickablePagination()) {
            const paginationEl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["s"])(swiper.pagination.el);
    ...
    on('beforeInit', ()=>{
        liveRegion = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["a"])('span', getParams().notificationClass);
    ...
    extendParams({
        hashNavigation: {
            ...
            getSlideIndex (_s, hash) {
                ...
                const matched = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["e"])(swiper.slidesEl, `.${swiper.params.slideClass}[data-hash="${hash}"], swiper-slide[data-hash="${hash}"]`)[0];
...
const Thumb = ({ swiper, extendParams, on })=>{
    ...
    function init() {
        ...
        if (thumbsParams.swiper instanceof SwiperClass) {
            ...
            thumbsSwiper.update();
        } else if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["r"])(thumbsParams.swiper)) {
    ...
    function onTouchMove() {
        ...
        if (data.velocities.length === 0) {
            data.velocities.push({
                ...
                time: data.touchStartTime ?? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["u"])()
            });
        }
        data.velocities.push({
    ...
    function onTouchEnd({ currentPos }) {
        ...
        if (freeModeParams.momentum) {
            if (data.velocities.length > 1) {
                ...
                if (time > 150 || (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["u"])() - lastMoveEvent.time > 300) {
                    swiper.velocity = 0;
                }
            } else {
                swiper.velocity = 0;
            ...
            if (freeModeParams.momentumBounce && doBounce && afterBouncePosition !== undefined) {
                ...
                swiper.animating = true;
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["m"])(wrapperEl, ()=>{
...
function appendSlide(slides) {
    ...
    const appendElement = (slideEl)=>{
        if (typeof slideEl === 'string') {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["w"])(tempDOM, slideEl);
            const child = tempDOM.children[0];
            if (child) slidesEl.append(child);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["w"])(tempDOM, '');
        } else {
            slidesEl.append(slideEl);
        }
    };
...
function effectTarget(_effectParams, slideEl) {
    const transformEl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["p"])(slideEl);
...
function effectVirtualTransitionEnd({ swiper, duration, transformElements, allSlides }) {
    ...
    if (swiper.params.virtualTranslate && duration !== 0) {
        ...
        transitionEndTarget.forEach((el)=>{
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["m"])(el, ()=>{
...
const EffectFade = ({ swiper, extendParams, on })=>{
    ...
    const setTransition = (duration)=>{
        const transformElements = swiper.slides.map((slideEl)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["p"])(slideEl));
...
const EffectCube = ({ swiper, extendParams, on })=>{
    ...
    const createSlideShadows = (slideEl, progress, isHorizontal)=>{
        ...
        if (!shadowBefore) {
            shadowBefore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["a"])('div', `swiper-slide-shadow-cube swiper-slide-shadow-${isHorizontal ? 'left' : 'top'}`.split(' '));
            slideEl.append(shadowBefore);
        }
        if (!shadowAfter) {
            shadowAfter = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["a"])('div', `swiper-slide-shadow-cube swiper-slide-shadow-${isHorizontal ? 'right' : 'bottom'}`.split(' '));
    ...
    const setTranslate = ()=>{
        ...
        if (params.shadow) {
            if (isHorizontal) {
                ...
                if (!cubeShadowEl) {
                    cubeShadowEl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["a"])('div', 'swiper-cube-shadow');
...
function createShadow(suffix, slideEl, side) {
    ...
    const shadowContainer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["p"])(slideEl);
    const selector = `.${shadowClass.split(' ').join('.')}`;
    const existing = shadowContainer.querySelector(selector);
    if (existing) return existing;
    const created = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swiper$2f$shared$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["a"])('div', shadowClass.split(' '));
...
//# sourceMappingURL=node_modules_swiper_1bnce1j._.js.map