...
// Captures and smooths normalized pointer input without knowing the renderer or React state.
export default class InputController {
  ...
  updateAvailability() {
    const intensity = this.config.input.pointer.intensity[this.profile];
